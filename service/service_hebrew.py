...
#
    ...
    def closing_message(self , final_status , name , urgency_status):
        ...
        if final_status == "Hot Lead":
            closing_message = (
                f"מעולה {name}, קיבלתי את הפרטים.\n"
                "נראה שזה יכול להתאים, וניצור איתך קשר בקרוב כדי להמשיך בצורה מסודרת."
                )
    
        elif final_status == "Cold Lead":
            closing_message = (
                f"תודה {name}, קיבלתי את הפרטים.\n"
                "כרגע זה נראה פחות מתאים, אבל אם זה יהיה רלוונטי בהמשך ניצור איתך קשר."
                )
    ...
    def generate_final_status_context(self , summary_info):
        if summary_info["final_status"] == "Hot Lead":
            final_status_context = "לקוח חם חדש 🔥"
        elif summary_info["final_status"] == "Cold Lead":
            final_status_context = "לקוח קר חדש 🧊"

        elif summary_info["final_status"] == "pending":
            final_status_context = "לקוח בתהליך ⏳"
