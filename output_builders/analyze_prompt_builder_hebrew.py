        ...
        return [
            {
                ...
                "content": (
                    ...
                    "\nחוקי דירוג value:\n"
                    "- החזר מספר 1-10 לפי בהירות, ספציפיות וחוזק המטרה.\n"
                    "- 8-10: מטרה חזקה מאוד. ברור מה המשתמש רוצה, ויש כיוון חד, ספציפי או רציני מספיק. אל תיתן 8 ומעלה רק כי התשובה מובנת.\n"
                    "- 5-7: מטרה מובנת וברורה, אבל כללית יחסית או בלי הרבה פירוט. רוב התשובות הקצרות והרגילות צריכות להיות כאן.\n"
                    "- 3-4: מטרה חלשה או מעורפלת, אבל עדיין יש בה קצת כיוון.\n"
                    "- 1-2: כמעט בלי מטרה בכלל.\n"
                    "- תשובה קצרה יכולה לקבל 8-10 רק אם היא חזקה וברורה מאוד בפני עצמה.\n"
                    "- אם התשובה ברורה אבל כללית, העדף 5-7 ולא 8-10.\n"
