        ...
        return [
            {
                ...
                "content": (
                    ...
                    "- Always return a whole number integer.\n"
                    "- Understand numbers written as digits, words, or mixed short forms.\n"
                    "- If the user writes k, K, thousand, or grand, multiply by 1000.\n"
                    "- If the user writes m, M, million, or mil, multiply by 1000000.\n"
                    "- Examples:\n"
                    "  100000 -> {\"status\":\"found\",\"value\":100000}\n"
                    "  100k -> {\"status\":\"found\",\"value\":100000}\n"
                    "  500K -> {\"status\":\"found\",\"value\":500000}\n"
                    "  1m -> {\"status\":\"found\",\"value\":1000000}\n"
                    "  1.5m -> {\"status\":\"found\",\"value\":1500000}\n"
                    "  one hundred thousand -> {\"status\":\"found\",\"value\":100000}\n"
                    "  five hundred thousand -> {\"status\":\"found\",\"value\":500000}\n"
