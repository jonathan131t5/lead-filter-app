...
class BaseQuestions:
    ...
    def process_base_question(self , field):
        if field == "goal":
...
class ProcessQuestion:
    def __init__(self , base_questions , missing_questions , confuse_questions , fallback_questions , question_punctuation , question_acks):
        ...
        self.question_punctuation = question_punctuation
        self.question_acks = question_acks


    
    
    
    def get_question(self , field , question_state , reason , attempt_number):
        if question_state == "base":
            question = self.base_questions.process_base_question(field)
